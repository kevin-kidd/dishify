...
CREATE UNIQUE INDEX `spanish_name_idx` ON `spanish_recipes` (`name`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `marketplace_ingredient_region_idx` ON `marketplace_prices` (`marketplace_slug`,`ingredient`,`region`);--> statement-breakpoint
CREATE TABLE `user_marketplace_preferences` (
	`id` text PRIMARY KEY NOT NULL,
	`user_id` text NOT NULL,
	`marketplace_slug` text NOT NULL,
	`region` text NOT NULL,
...
--> statement-breakpoint
CREATE UNIQUE INDEX `user_marketplace_idx` ON `user_marketplace_preferences` (`user_id`,`marketplace_slug`);