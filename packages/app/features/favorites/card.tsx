...
export function FavoriteCard({ recipe }: FavoriteCardProps) {
  ...
  const englishRecipe: EnglishRecipe = {
    ...
    data: recipe,
    createdAt: new Date().toISOString(), // Not used by the favorite button
    updatedAt: new Date().toISOString(), // Not used by the favorite button
    ...
    <Link href={`/dish/${recipe.slug}`}>
      ...
      >
        <div className="absolute right-4 top-4 flex gap-2">
          <FavoriteButton recipe={englishRecipe} />
