...
def parse_arguments():
    ...
    parser.add_argument("--table", "-t", default="recipes", help="Name of the table to insert into (default: recipes)")
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"Successfully generated SQL file containing {len(recipe_names)} VALUES for table '{args.table}'.")
